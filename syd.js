window.onload = function () {
    ...
    if ($("next")) {
        ...
        r.path(twitter).attr({fill: "#fff", stroke: "none", translation: [1000, y + 88], scale: 2});
        r.print(1064, y + 104, "Follow us", museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 64, 400, 64).attr({href: "http://twitter.com/sydjs", fill: "#000", opacity: 0});
    }
};