window.onload = function () {
    var step = 10,
        ...
        r = Raphael(0, 0, W * step * 2, H * step * 2),
    ...
    if ($("next")) {
        var museo = r.getFont("museosans");
        r.path(when).attr({fill: "#fff", stroke: "none", translation: "1000 100", scale: 2});
        r.print(1064, 116, $("when").innerHTML, museo, 24).attr({fill: "#fff"});
        i = 1;
        var y = 180;
        while ($("speaker" + i)) {
            i == 1 && r.path(who).attr({fill: "#fff", stroke: "none", translation: "1000 164", scale: 2});
            r.print(1064, y, $("speaker" + i).innerHTML, museo, 18).attr({fill: "#fff", opacity: .6});
            r.print(1064, y + 24 * 1.3, $("topic" + i).innerHTML, museo, 24).attr({fill: "#fff"});
            y += 24 * 1.3 * 2;
            i++;
        }
        r.path(where).attr({fill: "#fff", stroke: "none", translation: [1000, y + 24], scale: 2});
        r.print(1064, y + 40, $("where").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y, 400, 64).attr({href: $("where").href, fill: "#000", opacity: 0});
        r.path(twitter).attr({fill: "#fff", stroke: "none", translation: [1000, y + 164], scale: 2});
        r.print(1064, y + 184, $("twitter").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 150, 400, 64).attr({href: $("twitter").href, fill: "#000", opacity: 0});
        r.path(join).attr({fill: "#fff", stroke: "none", translation: [1000, y + 244], scale: 2});
        r.print(1064, y + 264, $("join").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 240, 400, 64).attr({href: $("join").href, fill: "#000", opacity: 0});
        r.path(archive).attr({fill: "#fff", stroke: "none", translation: [1000, y + 314], scale: 2});
        r.print(1064, y + 334, $("archive").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 334, 400, 64).attr({href: $("archive").href, fill: "#000", opacity: 0});
    }
};