window.onload = function () {
    ...
    if ($("next")) {
        ...
        r.path(register).attr({fill: "#fff", stroke: "none", translation: [1000, y + 94], scale: 2});
        r.print(1064, y + 114, $("register").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 84, 400, 64).attr({href: $("register").href, fill: "#000", opacity: 0});

        r.path(twitter).attr({fill: "#fff", stroke: "none", translation: [1000, y + 250], scale: 2});
        r.print(1064, y + 264, $("twitter").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 240, 400, 64).attr({href: $("twitter").href, fill: "#000", opacity: 0});

        r.path(join).attr({fill: "#fff", stroke: "none", translation: [1000, y + 330], scale: 2});
        r.print(1064, y + 344, $("join").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 320, 400, 64).attr({href: $("join").href, fill: "#000", opacity: 0});

        r.path(archive).attr({fill: "#fff", stroke: "none", translation: [1000, y + 410], scale: 2});
        r.print(1064, y + 424, $("archive").innerHTML, museo, 24).attr({fill: "#fff"});
        r.rect(1000, y + 400, 400, 64).attr({href: $("archive").href, fill: "#000", opacity: 0});
    }
};